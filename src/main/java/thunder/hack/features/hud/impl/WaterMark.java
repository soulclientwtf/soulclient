...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.thglitch.drawString(context.getMatrices(), "  PHASMO", getPosX() + 5.5, getPosY() + 5, -1);
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), "Phasmo ", getPosX() + 18, getPosY() + 5, 20);
                ...
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), ru.getValue() ? textUtil + " " : "phasmoclient ", getPosX() + 2, getPosY() + 2.5f, 10);
                FontRenderers.sf_bold.drawString(context.getMatrices(), info, getPosX() + 2 + FontRenderers.sf_bold.getStringWidth("phasmoclient "), getPosY() + 2.5f, HudEditor.textColor.getValue().getColor());
            ...
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "phasmoclient v" + ThunderHack.VERSION, getPosX() + 5.5f, getPosY() + 5, 10);
