...
public class Render2DEngine {
    ...
    public static void drawTracerPointer(MatrixStack matrices, float x, float y, float size, float tracerWidth, float downHeight, boolean down, boolean glow, int color) {
        switch (HudEditor.arrowsStyle.getValue()) {
            ...
            case Phasmo -> drawPhasmoArrow(matrices, x, y, size + 8, new Color(color));
            case Nova -> drawNovaArrow(matrices, x, y, size + 8, new Color(color));
        }
    }
    ...
    public static void drawPhasmoArrow(MatrixStack matrices, float x, float y, float size, Color color) {
        RenderSystem.setShaderTexture(0, TextureStorage.arrow2);
        setupRender();
        RenderSystem.setShaderColor(color.getRed() / 255f, color.getGreen() / 255f, color.getBlue() / 255f, color.getAlpha() / 255f);
        RenderSystem.disableDepthTest();
        RenderSystem.blendFunc(GlStateManager.SrcFactor.SRC_ALPHA, GlStateManager.DstFactor.ONE);
    ...
    public static void drawNovaArrow(MatrixStack matrices, float x, float y, float size, Color color) {
        RenderSystem.setShaderTexture(0, TextureStorage.arrow3);
        setupRender();
        RenderSystem.setShaderColor(color.getRed() / 255f, color.getGreen() / 255f, color.getBlue() / 255f, color.getAlpha() / 255f);
        RenderSystem.disableDepthTest();
        RenderSystem.blendFunc(GlStateManager.SrcFactor.SRC_ALPHA, GlStateManager.DstFactor.ONE);
