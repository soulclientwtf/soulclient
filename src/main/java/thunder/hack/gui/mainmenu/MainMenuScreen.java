...
public class MainMenuScreen extends Screen {
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.thglitchBig.drawCenteredString(context.getMatrices(), "PHASMOCLIENT BETA", (int) (halfOfWidth), (int) (halfOfHeight - 120), new Color(255, 255, 255, hoveredLogo ? 230 : 180).getRGB());
